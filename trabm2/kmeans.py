...
def ShowCluster(img, centroids, clusterLabels, title):
...
def KMeans3D(img, k=2, max_iterations=100, title='0'):
   '''
   ...
   for i in tqdm(range(max_iterations)):
       ...
       if Same:
           break
   ShowCluster(img, centroids, ClusterLabels, title + 'kmeans_' + str(k) + '_' + str(max_iterations) + '_' + str(maxi+1))